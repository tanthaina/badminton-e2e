...
5. **ระบบคลาวด์ (Cloud Sync):**
   - **(ใหม่)** ระบบซิงก์ข้อมูลระหว่างอุปกรณ์ (เช่น โทรศัพท์และแท็บเล็ต) ผ่าน JSONBin.io
   - **(ใหม่)** ระบบ Smart Auto-Sync ตรวจสอบและดึงข้อมูลให้อัตโนมัติเมื่อเปิดแอป
...
- **(ล่าสุด)** เพิ่มระบบ Cloud Sync, ค่าจิปาถะรายบุคคล, และฟีเจอร์ดูรายละเอียดหนี้
- **(ล่าสุด)** ปรับปรุง UI ให้แสดงสถานะ Offline และสถานะกำลังซิงก์ข้อมูล
- **(ล่าสุด)** แก้ไขและเพิ่ม Cypress Test Suite ให้ครอบคลุมฟีเจอร์ใหม่ทั้งหมด และแก้ไขปัญหา Race Condition ในการทดสอบ
